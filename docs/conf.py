...
latex_documents = [
    (master_doc, 'stochastic_lite.tex', u'stochastic_lite Documentation',
     u'Andrew Matas', 'manual'),
]
...
man_pages = [
    (master_doc, 'stochastic_lite', u'stochastic_lite Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'stochastic_lite', u'stochastic_lite Documentation',
     author, 'stochastic_lite', 'Lightweight stochastic GWB',
     'Miscellaneous'),
]
