...
In analysis, it is often important and useful to reweight quickly the output data to test
quickly some new code and/or run PE. Therefore, we opted to let the spectrogram
